...
class PaymentRoute extends AbstractPaymentRoute
{
    ...
    */
    ...
    // #[Route(path: '/store-api/easycredit/finalize-payment', name: 'store-api.easycredit.finalize-payment', methods: ['POST'])]
    // see routes.xml
    public function finalizePayment(Request $request, SalesChannelContext $salesChannelContext): PaymentRouteResponse
    {
